...
const { MAP_TASKS_INPUT } = require('../../../.mock.json');

describe('creates.map_tasks_in_list', () => {
    it('should run', async () => {
        const bundle = {
            authData: {
            ...
            inputData: {
                notionTasksObject: JSON.stringify(MAP_TASKS_INPUT),
        ...
        const results = await appTester(
            App.creates['map_tasks_in_list'].operation.perform,
            bundle
        );
